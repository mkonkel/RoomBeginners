...
object Migrations {
    ...
    val MIGRATION_3_4: Migration = object : Migration(3, 4) {
        override fun migrate(database: SupportSQLiteDatabase) {
            ...
            database.execSQL("INSERT INTO books_new(id, user_id, category_id, title, author_firstName, author_lastName) SELECT id, user_id, 5, title, author_firstName, author_lastName FROM books")
